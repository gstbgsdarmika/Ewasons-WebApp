          ...
          <div className="row">
            ...
            <div className="about-content col-lg-12">
              ...
              <ul className="list-group ms-5">
                <li>Menjual Sampah</li>
                <p>Kumpulkan sampah atau barang elektronik yang tidak terpakai yang Anda miliki kemudian urutkan berdasarkan jenisnya, lalu unggah pada webiste EwaSon untuk menjual barang elektronik bekas. Penjual di sekitar Anda akan memesan untuk membeli barang elektronik bekas yang Anda miliki.</p>

                <li>Mendapatkan Uang</li>
                <p>Dengan menjual sampah dengan aplikasi EwaSons, Anda dapat menjual sampah dengan harga sesuai dengan harga yang Anda inginkan.</p>

                <li>Mendapatkan Poin</li>
                <p> Setelah pembeli membeli sampah Anda, uang yang Anda terima berupa poin yang nantinya bisa ditukarkan dengan berbagai penawaran menarik</p>
              </ul>
            </div>
          </div>
        </div>
